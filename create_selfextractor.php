...
require ('config.php');
echo 'Creating the self-extracting file...';

if (!file_exists($arch1)) {die('File: '.$arch1.' does not exist. Please check the config.php!');}

$base64_output = 'zip-base64.txt'; // THIS IS A TEMPORARY OUTPUT FILE, ALREADY BASE64-ENCODED
$base64_temp = file_get_contents($arch1); //THIS READS THE ARCHIVE INTO A STRING
$base64_string = chunk_split(base64_encode ($base64_temp)); //THE STRING IS ENCODED TO BASE64 AND THEN SPLIT INTO SHORT LINES
                      

file_put_contents($base64_output, $base64_string);  //THE BASE 64 STRING IS WRITTEN TO THE OUTPUT FILE
      
$f_write = fopen ($installer, 'w'); //HERE, THE INSTALLER IS BUILT: FIRST THE CONTENT HERE, THEN THE BASE64 ENCODED ARCHIVE
